...
st.set_page_config(
    ...
    page_icon="../isaac-yeo/icons/heart_symbol.svg",
    layout="wide",
)
...
try:
    ...
    model_bundle = joblib.load("../isaac-yeo/model/heart_disease_model_gbt_rs.pkl")
...
st.markdown(
    ...
    <div class="footer-card">
        Heart Disease Decision-Support Tool<br>
        For educational demonstration only. This output is not a medical diagnosis.
    </div>
    """,
    unsafe_allow_html=True,
)
