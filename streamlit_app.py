...
st.markdown(
    ...
    /* Keep each validation message close to its matching input. */
    [data-testid="stElementContainer"]:has(.field-error) {
        margin-top: -10px;
        margin-bottom: 8px;
    }
    ...
    if validation_errors:
        ...
        try:
            ...
            with st.expander("Prediction details"):
                ...
                st.write(
                    "Representation notice: Female patients were underrepresented in the training data. "
                    "Predictions for female patients may therefore be less reliable and should be interpreted cautiously alongside professional clinical assessment."
                )
